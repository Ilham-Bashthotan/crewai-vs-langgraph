...
[![Image 1: ben burtenshaw's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/62d648291fa3e4e7ae3fa6e8/oatOwf8Xqe5eDbCSuYqCd.png)](https://huggingface.co/burtenshaw)

[![Image 2: Vaibhav Srivastav's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1655385361868-61b85ce86eb1f2c5e6233736.jpeg)](https://huggingface.co/reach-vb)

[![Image 3: Pedro Cuenca's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1617264212503-603d25b75f9d390ab190b777.jpeg)](https://huggingface.co/pcuenq)

[![Image 4: Clem 🤗's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/1583857146757-5e67bdd61009063689407479.jpeg)](https://huggingface.co/clem)

[![Image 5: Rajat Arya's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/667c7853ed85453a28a05f19/H2gcBeOAorIsQj3vNinYB.jpeg)](https://huggingface.co/rajatarya)

[![Image 6: Jared Sulzdorf's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/65d50e9ef9cbfa798c590004/FlVe8chafigMfrPpMeJRL.jpeg)](https://huggingface.co/jsulz)

[![Image 7: Lysandre's avatar](https://cdn-avatars.huggingface.co/v1/production/uploads/5e3aec01f55e2b62848a5217/PMKS0NNB4MJQlTSFzh918.jpeg)](https://huggingface.co/lysandre)
...
[](https://huggingface.co/blog/llama4-release#what-is-llama-4) What is Llama 4?
-------------------------------------------------------------------------------
...
[](https://huggingface.co/blog/llama4-release#features-and-integrations-on-hugging-face) Features and Integrations on Hugging Face
----------------------------------------------------------------------------------------------------------------------------------
...
[](https://huggingface.co/blog/llama4-release#context-length-and-architecture-choices) Context Length and Architecture Choices
------------------------------------------------------------------------------------------------------------------------------
...
[](https://huggingface.co/blog/llama4-release#how-to-use-with-transformers) How to Use with Transformers
--------------------------------------------------------------------------------------------------------
...
[](https://huggingface.co/blog/llama4-release#evaluation-scores) Evaluation Scores
----------------------------------------------------------------------------------
...
### [](https://huggingface.co/blog/llama4-release#pre-trained-models) Pre-trained models
...
### [](https://huggingface.co/blog/llama4-release#instruction-tuned-models) Instruction tuned models
...
[](https://huggingface.co/blog/llama4-release#acknowledgments) Acknowledgments
------------------------------------------------------------------------------
...
[](https://huggingface.co/blog/llama4-release#references) References
--------------------------------------------------------------------
